...
def plot_neuron_trial(filename):
  ...
  plt.subplot(311)
  plt.title('neuron:   ||u|| = ' + str(round(control_effort,2)) \
             + ',  ||e|| = ' + str(round(error,2)))
  ...
  plt.plot(r11d,label='r11')
  plt.plot(r12d,label='r12')
  plt.plot(l21d,label='l21')
  plt.plot(l22d,label='l22')
  plt.plot(r21d,label='r21')
  plt.plot(r22d,label='r22')
  plt.legend(loc='lower right')
  plt.ylabel('desired')
  plt.xlabel('timestep')
  plt.xlim(0, win)

  plt.savefig('neuron.eps', format='eps', dpi=1200)
  plt.show()

if __name__ == '__main__':
  plot_neuron_trial(*sys.argv[1:])
